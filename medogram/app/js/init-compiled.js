...
;(function initApplication() {
  ...
  var classes = [Config.Navigator.osX ? 'osx' : 'non_osx', Config.Navigator.msie ? 'msie' : 'non_msie', Config.Navigator.retina ? 'is_2x' : 'is_1x'];
  ...
  ConfigStorage.get('layout_selected', 'i18n_locale', function (params) {
    ...
    $('head').append('<link rel="stylesheet" href="css/' + (Config.Mobile ? 'mobile.css' : 'desktop.css') + '" />');
    ...
    $(document).ready(function () {
      ...
      if (!bootReady.i18n_ng) {
        // onDOMready because needs to be after angular
