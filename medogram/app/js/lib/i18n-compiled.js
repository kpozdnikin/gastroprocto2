...
angular.module('myApp.i18n', ['izhukov.utils']).factory('_', ['$rootScope', '$locale', function ($rootScope, $locale) {
  ...
  function parseMarkdownString(msgstr, msgid) {
    msgstr = msgstr.replace(/\*\*(.+?)\*\*/g, '<strong>$1</strong>').replace(/\n|&#10;/g, '<br/>');
...
//# sourceMappingURL=i18n-compiled.js.map