...
angular.module("ngLocale", [], ["$provide", function ($provide) {
  ...
  $provide.value("$locale", {
    "DATETIME_FORMATS": {
      ...
      "SHORTDAY": ["Sv", "Pr", "Ot", "Tr", "Ce", "Pk", "Se"],
      "SHORTMONTH": ["janv.", "febr.", "marts", "apr.", "maijs", "j\u016Bn.", "j\u016Bl.", "aug.", "sept.", "okt.", "nov.", "dec."],
    ...
    "pluralCat": function pluralCat(n, opt_precision) {
      var vf = getVF(n, opt_precision);if (n % 10 == 0 || n % 100 >= 11 && n % 100 <= 19 || vf.v == 2 && vf.f % 100 >= 11 && vf.f % 100 <= 19) {
...
//# sourceMappingURL=angular-locale_lv-compiled.js.map