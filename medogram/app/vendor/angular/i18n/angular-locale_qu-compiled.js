...
angular.module("ngLocale", [], ["$provide", function ($provide) {
  ...
  $provide.value("$locale", {
    "DATETIME_FORMATS": {
      ...
      "ERAS": ["BCE", "d.C."],
      "FIRSTDAYOFWEEK": 6,
      "MONTH": ["Qulla puquy", "Hatun puquy", "Pauqar waray", "Ayriwa", "Aymuray", "Inti raymi", "Anta Sitwa", "Qhapaq Sitwa", "Uma raymi", "Kantaray", "Ayamarq\u02BCa", "Kapaq Raymi"],
      "SHORTDAY": ["Dom", "Lun", "Mar", "Mi\xE9", "Jue", "Vie", "Sab"],
...
//# sourceMappingURL=angular-locale_qu-compiled.js.map