...
angular.module("ngLocale", [], ["$provide", function ($provide) {
  ...
  $provide.value("$locale", {
    "DATETIME_FORMATS": {
      "AMPMS": ["AM", "PM"],
      "DAY": ["s\xF8ndag", "mandag", "tirsdag", "onsdag", "torsdag", "fredag", "l\xF8rdag"],
      "ERANAMES": ["f.Kr.", "e.Kr."],
      "ERAS": ["f.Kr.", "e.Kr."],
      "FIRSTDAYOFWEEK": 0,
      "MONTH": ["januar", "februar", "marts", "april", "maj", "juni", "juli", "august", "september", "oktober", "november", "december"],
      "SHORTDAY": ["s\xF8n.", "man.", "tir.", "ons.", "tor.", "fre.", "l\xF8r."],
    ...
    "pluralCat": function pluralCat(n, opt_precision) {
      var i = n | 0;var vf = getVF(n, opt_precision);var wt = getWT(vf.v, vf.f);if (n == 1 || wt.t != 0 && (i == 0 || i == 1)) {
...
//# sourceMappingURL=angular-locale_da-compiled.js.map