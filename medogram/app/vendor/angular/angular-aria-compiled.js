...
(function (window, angular) {
  ...
  */
  ...
  var isNodeOneOf = function isNodeOneOf(elem, nodeTypeArray) {
  ...
  function $AriaProvider() {
    ...
    this.config = function (newConfig) {
      _config = angular.extend(_config, newConfig);
    };

    function watchExpr(attrName, ariaAttr, nodeBlackList, negate) {
      return function (scope, elem, attr) {
        var ariaCamelName = attr.$normalize(ariaAttr);
        if (_config[ariaCamelName] && !isNodeOneOf(elem, nodeBlackList) && !attr[ariaCamelName]) {
  ...
  ngAriaModule.directive('ngShow', ['$aria', function ($aria) {
    ...
    return {
      ...
      compile: function compile(elem, attr) {
        ...
        return {
          pre: function pre(scope, elem, attr, ngModel) {
            if (shape === 'checkbox') {
          ...
          post: function post(scope, elem, attr, ngModel) {
    ...
    return {
      restrict: 'A',
      require: '?ngMessages',
      link: function link(scope, elem, attr, ngMessages) {
