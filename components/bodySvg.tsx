...
export const BodySvg: React.FC<{zones: Array<number>, selectedPathStyle: PathStyleInterface}> = (props) => {
	...
	return (
		<div className="stomachache-left-block" ref={bodySvgRef}>
			...
			C1078.1,727.6,1079.6,730.2,1081.2,729.2L1081.2,729.2z"/>
				...
				<path id="svg-2" style={zones.indexOf(2) !== -1 ? selectedPathStyle : {}} className="st0 svg-2" d="M603.1,776.6c0-1.1,0-2.4,0-3.7c-36.8,0-73.4,0-110.1,0c0-0.1-0.1-0.2-0.1-0.3c0.3-0.2,0.6-0.5,0.9-0.7
	...
	c0.3,25.2,0.5,50.3,0.7,75.5c1,0,2,0,3.2,0c-2,2.3-3.8,4.4-5.6,6.5C603.3,776.6,603.2,776.6,603.1,776.6z"/>
				<g>
					<path className="st0" d="M606.6,970.6c0-0.4,0-0.9,0-1.4c0.4-0.1,0.9-0.1,1.4-0.2c0.2-62.9,0.5-125.8,0.7-188.8
		c-0.5-0.1-0.9-0.1-1.4-0.2c0-0.5,0-1,0-1.5c0.6,0,1.1,0,1.7,0c0,64,0,128,0,192C608.2,970.6,607.4,970.6,606.6,970.6z"/>
					<path id="svg-5" style={zones.indexOf(5) !== -1 ? selectedPathStyle : {}} className="st0 svg-5" d="M605.1,967.4c-46.4,0-92.7,0-139.1,0c0.5-2,0.9-3.9,1.5-5.8c5.4-17.2,10.8-34.5,16.3-51.6
		...
		c0-1.5,0-2.9,0-4.5c37.7,0,75.4,0,113.1,0"/>
				...
				<path id="svg-8" style={zones.indexOf(8) !== -1 ? selectedPathStyle : {}} className="st0 svg-8" d="M466,974.3c0.4,2.2,0.8,4.4,1.2,6.4c2.4,10.9,5.9,21.4,11.4,31.2c2.8,5,6,9.8,8.9,14.8
	...
	c0-84.1,0-167.9,0-251.8c-47.7,0-95.4,0-143.1,0C466,973.9,466,974.1,466,974.3z"/>
				<path id="svg-1" style={zones.indexOf(1) !== -1 ? selectedPathStyle : {}} className="st0 svg-1" d="M891.7,709.1c0-1.5-0.4-2.7-1.8-3.4c-8.8-5.1-17-11.3-24.8-17.8c-13-10.9-25.1-22.9-36.7-35.3
	...
	c0.5-0.1,0.9-0.2,1.3-0.3c0-0.5,0-1,0-1.4c0-6.1,0-12.1,0-18.2C891.7,737.9,891.7,723.5,891.7,709.1z"/>
				<path id="svg-3" style={zones.indexOf(3) !== -1 ? selectedPathStyle : {}} className="st0 svg-3" d="M896.9,772.8c36.7-0.2,73.2-0.3,109.6-0.5c-1.4-0.8-2.8-1.2-4.2-1.9c-10.3-4.8-20.7-9.7-31.1-14.6
	...
	C897.4,734.3,897.2,753.5,896.9,772.8z"/>
				<path id="svg-4" style={zones.indexOf(4) !== -1 ? selectedPathStyle : {}} className="st0 svg-4" d="M891.7,967.4c-92.3,0-184.6,0-277,0c0-0.6,0.1-1.2,0.1-1.8c0-61.1,0-122.1,0-183.2c0-0.6,0-1.2,0-1.8
	c92.4,0,184.6,0,276.8,0C891.7,843,891.7,905.2,891.7,967.4z"/>
				<path className="st1" d="M639.3,811.1c0,0.5,0,0.9,0,1.6c-0.5,0-1-0.1-1.4-0.1c0-0.5,0-1,0-1.4C638.4,811.1,638.8,811.1,639.3,811.1z"/>
				<path id="svg-7" style={zones.indexOf(7) !== -1 ? selectedPathStyle : {}} className="st0 svg-7" d="M850.3,1249.8c8.7-5.4,17.4-10.9,26.1-16.3c4.7-2.9,9.2-5.8,13.1-9.6c0.6-0.6,0.8-1.2,0.8-2
	...
	c11.1,2.3,22.3,4.2,33.6,5.6c10.4,1.3,21,2,31.5,1.7c13.5-0.4,26.5-2.9,39.3-7.2C822,1265.5,836.4,1258.2,850.3,1249.8z"/>
				<path id="svg-9" style={zones.indexOf(9) !== -1 ? selectedPathStyle : {}} className="st0 svg-9" d="M897.4,1217.8c-0.2-0.1-0.4-0.1-0.5-0.2c-0.1-0.3,0-0.6,0-0.8c0-81.1,0-162.1,0-243.2c0.3,0,0.6,0,0.8,0
	...
	C902.2,1213.7,899.7,1215.7,897.4,1217.8z"/>
				<path id="svg-6" style={zones.indexOf(6) !== -1 ? selectedPathStyle : {}} className="st0 svg-6" d="M1012.2,844.5c-0.2-6.6-0.3-13.3-0.4-19.9c-0.1-13.1-0.1-26.3-0.2-39.4c0-1.5,0-3,0-4.6c-38.3,0-76.6,0-114.7,0
