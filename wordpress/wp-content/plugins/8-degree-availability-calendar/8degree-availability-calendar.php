...
if (!class_exists('Edac_Class')) {
    ...
    class Edac_Class {
         ...
         * */
         ...
         function edac_menu(){
            add_menu_page( __('Availability Calendar','edac-plugin'), __('Availability Calendar','edac-plugin'),'administrator','edac-plugin', array($this, 'edac_setting_page'), 'dashicons-calendar-alt' );
         }
